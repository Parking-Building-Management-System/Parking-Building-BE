...
public class AdminMasterDataController {
  ...
  @Operation(
      ...
      description =
          "Returns all global vehicle categories. The list is cached in Redis without TTL and"
              + " evicted only when vehicle type data changes.")
  ...
  @io.swagger.v3.oas.annotations.responses.ApiResponse(
      ...
      content =
          @Content(
              array = @ArraySchema(schema = @Schema(implementation = AdminRoleResponse.class))))
